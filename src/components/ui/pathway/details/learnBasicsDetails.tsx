    ...
    <>  
      <div>
        ...
        <ul className='list-disc [&>li]:ml-4'>
          <li>CS fundamentals: networking fundamentals, RFCs for HTTP, REST dissertation</li>
          <li>Books: <span className='italic'>Clean Code, The Pragmatic Programmer, Refactoring, Software Engineering at Google</span></li>
          <li>Online courses:
