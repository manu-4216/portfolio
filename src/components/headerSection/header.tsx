      ...
      <div className='flex flex-row gap-4 items-center justify-between'>
        <div className='flex flex-col gap-1'>
          ...
          <div className='text-sm text-slate-800 mb-2 hidden sm:block'>
            <Tags variant='outline' tags={['React', 'TypeScript', 'node.js']} />
          </div>
        </div>
        ...
        <div className='flex flex-col items-center'>
          <Avatar
            className={cn(
              'w-[50px] h-auto sm:w-[80px] mx-2 border-2 rounded-full border-slate-600'
            )}
          >
            <AvatarImage src='https://github.com/manu-4216.png' />
            <AvatarFallback>MM</AvatarFallback>
          </Avatar>
          <div className='text-xs text-slate-900 text-nowrap'>{location}</div>
        </div>
